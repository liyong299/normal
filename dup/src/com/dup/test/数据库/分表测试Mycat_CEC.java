...
public class 分表测试Mycat_CEC
{
	...
	{
		String dbURL = "jdbc:mysql://172.16.34.12:8066/cec_ly?useUnicode=true&characterEncoding=utf-8&autoReconnect=true";
		String userName = "cec";
		String password = "cec";
		...
		select(3); // 可以
		selectwhere("00f01c43-6a44-4660-9bde-57eabd8b7031");
//		selectrang("1");
//		insert(1);
//		update(1);
//		delete(3);
//		deleteall(); // 不可以
	...
	{
		String sql2 = "select * from CEC_TicketOrder limit ";
		executorQuery(sql2 + num);
	}
	
	public static void selectwhere(String id)
	{
		String sql2 = "select * from CEC_TicketOrder where id = '";
		executorQuery(sql2 + id + "'");
	}
	
	public static void selectrang(String id)
	{
