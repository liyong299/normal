 ...
 * 
 * CHANGES: -------- 19-Nov-2002 : CODING STYLE CHANGES ONLY (by David Gilbert
 * for Object Refinery Limited); 19-Sep-2003 : Fix for platforms using EBCDIC
 * (contributed by Paulo Soares); 19-Oct-2003 : Change private fields to
 * protected fields so that PngEncoderB can inherit them (JDE) Fixed bug with
 * calculation of nRows
 */
...
public class PngEncoder extends Object {
	...
	/**
	 * Class constructor specifying Image to encode, whether to encode alpha, and
	 * filter to use.
	 * 
	 * @param image
	 *          A Java Image object which uses the DirectColorModel
	...
	/**
	 * Write an array of bytes into the pngBytes array. Note: This routine has the
	 * side effect of updating maxPos, the largest element written in the array.
	 * The array is resized by 1000 bytes or the length of the data to be written,
	 * whichever is larger.
	 * 
	 * @param data
	...
	/**
	 * Write an array of bytes into the pngBytes array, specifying number of bytes
	 * to write. Note: This routine has the side effect of updating maxPos, the
	 * largest element written in the array. The array is resized by 1000 bytes or
	...
	/**
	 * Perform "sub" filtering on the given row. Uses temporary array leftBytes to
	 * store the original values of the previous pixels. The array is 16 bytes
	 * long, which will easily hold two-byte samples plus two-byte alpha.
	 * 
	 * @param pixels
