 ...
 * Interchange Format</A>). A GIFEncoder is constructed with either an AWT
 * Image (which must be fully loaded) or a set of RGB arrays. The image can be
 * written out with a call to <CODE>Write</CODE>.
 * <P>
 * 
 * Three caveats:
 * <UL>
 ...
 * <P>
 * 
 * <LI>The image cannot have more than 256 colors, since GIF is an 8 bit
 * format. For a 24 bit to 8 bit quantization algorithm, see Graphics Gems II
 * III.2 by Xialoin Wu. Or check out his <A
