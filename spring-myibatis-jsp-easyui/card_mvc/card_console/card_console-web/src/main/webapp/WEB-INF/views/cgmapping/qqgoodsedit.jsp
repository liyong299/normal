...
<easyui:templateOverride name="body">
    <easyui:layout id="main" fit="true">
       <form  id="updateForm"  class="edit_box"  action="" >
       				<input type="hidden" name="id" value="${qqgsmap.id }"/>
					<table align="center" width="480px" class="edit_tr">
						<tr>
							<td align="right">QQ产品类型：</td>
							<td><input class="easyui-textbox" name="qqgoodstype"
								style="width: 60%; height: 25px" value="${qqgsmap.qqgoodstype}"></td>
						</tr>
						<tr>
							<td width="150" height="30" align="right">兜有影院编号：</td>
							<td><input class="easyui-textbox" name="cinemano"
								style="width: 60%; height: 25px" value="${qqgsmap.cinemano}">
						...
						<tr>
							...
							<td><input name="goodsid" class="easyui-textbox"
								style="width: 60%; height: 25px" value="${qqgsmap.goodsid}"></td>
						</tr>
						<tr>
							<td align="right">兜有商品类型：</td>
							<td><input name="goodstype" class="easyui-textbox"
								style="width: 60%; height: 25px" value="${qqgsmap.goodstype}"></td>
						</tr>
					</table>
