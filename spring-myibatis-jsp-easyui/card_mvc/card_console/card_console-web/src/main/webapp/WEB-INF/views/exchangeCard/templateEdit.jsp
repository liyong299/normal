...
<easyui:templateOverride name="title">编辑模板</easyui:templateOverride>
		...
		<div data-options="region:'center',split:true" style="border:0" >
			<easyui:tabs id="tabs">
				<easyui:tab title="基本信息">
					<div class="edit-box">
						<div class="item"><label>模板名称：</label><easyui_ext:textBox id="txt_name" value="${template.templatename}"/><span class="star">*</span></div>
						<div class="item item_row">
							<label>通用价格（元）：</label>
							<easyui_ext:textBox id="txt_common_price" value="${template.common_price / 100}"/><span class="star">*</span>
						</div>
