...
<fieldset style="border: solid 1px; border-color: rgba(0, 0, 0, 0.18);">
		<legend>错误信息</legend>
		<span>
			<textarea id="expMsg" class="textbox-text validatebox-text" placeholder="" style="margin-left: 0px; margin-right: 0px; height:90px; width: 540px;">${expMsg}</textarea>
		</span>
	</fieldset>
	<fieldset style="border: solid 1px; border-color: rgba(0, 0, 0, 0.18);">
		<legend>错误来源</legend>
