...
<easyui:templateOverride name="body">
	<form id="info" class="edit_box"  method="post" action="">
	  <div class="items">
        	<label style="width: 120px" for="itemName">通兑票编码<em>*</em>：</label> 
			<input name="code" value="${saleCommonTicket.code }" class="easyui-textbox easyui-validatebox" type="text" readonly="readonly"/>
        </div>
        <div class="items">
        ...
        <%--  <div  class="items" id="settlDiv">
			...
			<input name="settl_price" value="${saleCommonTicket.settl_price}" class="easyui-textbox easyui-validatebox" required="true" type="text" validType="pnumber" missingMessage="结算价不能为空"/>
         ...
         <div class="items">
			...
			<select id="cc" class="easyui-combobox" name="channel_type" style="width:200px;" value="${saleCommonTicket.channel_type }">   
         ...
         <div  class="items">
        	...
        	<textarea rows="3" cols="40" class="textbox easyui-validatebox" name="pos_position">${saleCommonTicket.pos_position }</textarea>
        </div>
         <div  class="items">
        	<label style="width: 120px" for="itemName">凭证下发辅助说明<em>*</em>：</label> 
			<textarea rows="3" cols="40" class="textbox easyui-validatebox" name="validate_memo">${saleCommonTicket.validate_memo }</textarea>
        </div>
        <div  class="items">
        	<label style="width: 120px" for="itemName">凭证打印说明<em>*</em>：</label> 
			<textarea rows="3" cols="40" class="textbox easyui-validatebox" name="print_memo">${saleCommonTicket.print_memo }</textarea>
        </div>
        <div  class="items">
        	<label style="width: 120px" for="itemName">网站显示备注<em>*</em>：</label> 
			<textarea rows="3" cols="40" class="textbox easyui-validatebox" name="web_memo">${saleCommonTicket.web_memo }</textarea>
        </div>
...
<easyui:templateOverride name="script">
	...
	function doSave() {	
		if($('#info').form('validate')){
			if(!validFn()){
					...
					$.ajax({
						cache : true,
						type : "POST",
						url : "${pageContext.request.contextPath }/ticketMultiply/saveupdate.do",
		...
		function Cancel() {
			parent.$('#tabs').tabs('close', '多家通兑票编辑');
		}
