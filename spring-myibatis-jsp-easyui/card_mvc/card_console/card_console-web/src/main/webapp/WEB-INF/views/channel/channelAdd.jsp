...
<easyui:templateOverride name="body">
   <div class="item">
        <form id="updateForm" class="edit_box">
            <div  class="item">
					<label for="itemName">渠道编号：<span class="star">*</span></label> 
					<easyui_ext:textBox id="channelno" name="channelno"  value="" ></easyui_ext:textBox>
			</div>
			<div  class="item">
					<label for="itemName">渠道名称 ：<span class="star">*</span></label> 
					<easyui_ext:textBox id="channelname" name="channelname"  value="" ></easyui_ext:textBox>
			</div>
			<div  class="item">
					<label for="itemName">渠道类型 ：<span class="star">*</span></label> 
			...
			<div  class="item">
					<label for="itemName">结算方式：<span class="star">*</span></label> 
					<easyui_ext:comboBox id="settlType" name="settlType"  value="" width="<%= com.mopon.helpers.ui.combobox.Width.NORMAL %>"  data="<%= com.mopon.helpers.ui.combobox.Data.getSettlTypeList() %>" ></easyui_ext:comboBox>
			</div>
			<div  class="item">
					<label for="itemName">分成方式：<span class="star">*</span></label> 
					<easyui_ext:comboBox id="dividedType" name="dividedType"  value="" width="<%= com.mopon.helpers.ui.combobox.Width.NORMAL %>"  data="<%= com.mopon.helpers.ui.combobox.Data.getdividedTypeList() %>"/>
			</div>
			<div  class="item">
					<label for="itemName">分成单价：</label> 					
					<easyui_ext:textBox id="unitPrice" name="unitPrice" value="" validType="pnumber"></easyui_ext:textBox>元
			</div>
			<div  class="item">
					<label for="itemName">分成比例：</label> 
					<easyui_ext:textBox id="rate" name="rate" value="" validType="pnumber"></easyui_ext:textBox>%
			</div>		
			<div  class="item">
					<label for="itemName">渠道级别：<span class="star">*</span></label> 
					<easyui_ext:comboBox id="channelLevel" name="channelLevel"  value="" width="<%= com.mopon.helpers.ui.combobox.Width.NORMAL %>"  data="${channelLevelList}" ></easyui_ext:comboBox>
			</div>
			<div  class="item">
					<label for="itemName">父级渠道：<span class="star">*</span></label> 
					<easyui_ext:comboBox id="parentchannelno" name="parentchannelno"  value="" width="<%= com.mopon.helpers.ui.combobox.Width.NORMAL %>"  data="${parentChannelKvpList}" ></easyui_ext:comboBox>
			</div>		
			
			<div  class="item">
					<label for="itemName">渠道关键字：</label> 
					<easyui_ext:textBox id="channelKey" name="channelKey" value="" ></easyui_ext:textBox>
			</div>
			<div  class="item">
					<label for="itemName">渠道域名地址：</label> 
					<easyui_ext:textBox id="channelUrl" name="channelUrl"  value=""></easyui_ext:textBox>
			</div>
			<div  class="item">
					<label for="itemName">渠道对接类型：</label> 
					<easyui_ext:comboBox id="dockingType" name="dockingType"  value="" width="<%= com.mopon.helpers.ui.combobox.Width.NORMAL %>"  data="${dockingTypeList}" ></easyui_ext:comboBox>
			</div>			
					
			<div  class="item">
					<label for="itemName">下方凭证方式：<span class="star">*</span></label> 
			...
			<a class="easyui-linkbutton" onclick="doAdd()">保存</a>
...
<easyui:templateOverride name="script">
	...
	$(function(){	
		...
		$("#channelLevel").combobox("select","2");
