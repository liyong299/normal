...
<easyui:templateOverride name="body">
    <easyui:layout id="main" fit="true">
       <form  id="updateForm"  class="edit_box"  action="" >
       				<input type="hidden" name="id" value="${wxcmmap.id }"/>
					<table align="center" width="480px" class="edit_tr">
						<tr>
							<td width="242" height="30" align="right">QQ影院编号：</td>
							<td><input class="easyui-textbox" name="wxcinemano"
								style="width: 60%; height: 25px" value="${wxcmmap.wxcinemano}"></td>
						</tr>
						<tr>
							<td width="242" height="30" align="right">兜有影院编号：</td>
							<td><input class="easyui-textbox" name="cinemano"
								style="width: 60%; height: 25px" value="${wxcmmap.cinemano}">
...
<easyui:templateOverride name="script">
	...
	function doSave() {	
		$.ajax({
            cache: true,
            type: "POST",
            url:"../cgmapping/savewxcmmap.do",
            data:$('#updateForm').serialize(),// 你的formid
            dataType: "json",
            async: false,
            error: function(request) {
            	 $.messager.alert('信息提示',"Connection error");
            },
