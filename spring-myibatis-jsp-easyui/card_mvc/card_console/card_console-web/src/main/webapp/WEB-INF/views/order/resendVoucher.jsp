...
<form id="info" class="edit_box"  method="post" action="">
	<input id="channleId" type="hidden" value="${channleId}"> 
	<div class="item"><label>订单号：</label><easyui_ext:textBox id="orderNo" name="orderNo"  value="${orderNo}"/></div>
	<div class="item"><label>手机号：</label><easyui_ext:textBox id="sendMobile" name="sendMobile"  value="${mobile}" required="true" validType="mobile"/></div>
...
<easyui:templateOverride name="script">
	<script>
		function Send(){
			...
			var channleId = $("#channleId").val();
			var data={orderNo:orderNo,sendMobile:sendMobile,channleId:channleId};
