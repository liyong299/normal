	...
	<easyui:layout id="main" fit="true">
		<easyui_ext:searchCondition id="search-form">
				<easyui_ext:searchItem name="订单号"><easyui_ext:textBox id="orderNo" /></easyui_ext:searchItem>
 			    <easyui_ext:searchItem name="凭证号"><easyui_ext:textBox id="voucherCode"  /></easyui_ext:searchItem>
		...
		<easyui:layoutUnit region="center" border="false">
			<easyui:datagrid id="datalist"   rownumbers="true"  url="queryBusinessLog.do" fit="true" pageSize="30" pagination="true" >
			    ...
			    <easyui:column field="logID"  align="center"  width="60" title="ID" /> 
			        <%-- <easyui:column field="bizTypeValue" title="业务类型字典值" align="center"  width="100" formatter="datalist.orderType"/> --%>
			        <easyui:column field="bizType"  align="center"  width="100" title="业务类型" formatter="numFormat"/>
			     <%--    <easyui:column field="bizStepValue"  align="center"  width="100" title="业务步骤字典值" /> --%>
			        <easyui:column field="bizStep" align="center"  width="100" title=" 业务步骤"/>
			        <easyui:column field="orderNo"  align="center"  width="80" title="订单号"/>
			        <easyui:column field="voucherCode" align="center"  width="80"  title="凭证号"/>
			        <easyui:column field="mobileNo"  align="center"  width="120"  title="手机号"/>
			        <easyui:column field="cinemaNo"  align="center"  width="100" title="影院编号"/>
...
<easyui:templateOverride name="script">
	<script>
		var datalist = {
	        ...
	        Edit: function(memo) {
	        	$("#layout_box iframe").attr("src", encodeURI(encodeURI("businessLogDetail.html?memo="+memo)));
	            $('#layout_box').window({
	                title: "查看详情"
	            });
	        },
