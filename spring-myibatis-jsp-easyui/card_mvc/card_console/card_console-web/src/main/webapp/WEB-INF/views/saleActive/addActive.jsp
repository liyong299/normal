...
<easyui:templateOverride name="title">添加活动</easyui:templateOverride>
	...
	<form id="info" class="edit_box" method="post" action="">
		<fieldset class="fieldset">
			...
			<div class="item">
				...
				<easyui_ext:textBox id="actName" required="true" />
			</div>
			<div class="item">
				<label>活动类型<span class="star">*</span>：</label>
				<easyui_ext:comboBox id="actType" required="true" name="actType" data="${activeTypeList}" />
			</div>
			<div class="item">
				<label>活动主题<span class="star">*</span>：</label>
				<easyui_ext:textBox id="actTheme" required="true" />
			</div>
			<div class="item">
				<label id="actPrice_tip">活动价格<span class="star">*</span>：</label>
				<easyui_ext:textBox id="actPrice" required="true" validType="currency"/>
			</div>
			<div class="item">
				<label>参考价格<span class="star">*</span>：</label>
				<easyui_ext:textBox id="actNormalPrice" required="true" validType="currency"/>
			</div>
			<div class="item">
				<label>活动补贴金额：</label>
				<easyui_ext:textBox id="actSubsidy" validType="currency" />
			</div>
			<div class="item">
				<label>销售服务人员：</label>
				<easyui_ext:textBox id="actSalesman" />
			</div>
			<div class="item">
				<label>活动联合举办单位：</label>
				<easyui_ext:textBox id="actCompany" />
			</div>
			<div class="item item_row" style="clear:both">
				<label>活动简介<span class="star">*</span>：</label>
				<easyui_ext:textBox multiline="true"  height="100" width="400"  id="actSummary" required="true" validType="maxLength[140]" />
			</div>
		</fieldset>
		<fieldset class="fieldset">
			...
			<fieldset class="fieldset">
				...
				<div class="items">
					...
					<input id="beginDate" name="beginDate" type="text" class="easyui-datebox easyui-validatebox" required="true" validType="dateCompare['#beginDate','#endDate']" > -
					<input id="endDate" name="endDate" type="text" class="easyui-datebox easyui-validatebox" required="true" validType="dateCompare['#beginDate','#endDate']" >
				</div>
				<div class="items">
					<label>选择星期（不选则不限制星期！）：
					</label> <label><input name="weeks" value="1" type="checkbox" />周一</label>
			...
			<fieldset class="fieldset">
				...
				<div class="items" id="cinema_area">
			        ...
			        <div id="areaSelectResult" style="overflow: auto;height:100px;"></div>
				</div>
				<div class="items" id="voucher_area" style="display: none">
					<label>匹配通兑票：</label>
					<div id="voucher_div" style="display: inline"></div>
...
<!-- 			        <input id="filmSelectAll" name="areaSelect" value="选择全部影片" type="button" onclick="showFilmSelectAll()" visibility/> -->
				</div>
<!-- 				<div class="items" id="showtype"> -->
<!-- 						<label style="width: 120px" for="itemName">放映类型：</label> -->
<!-- 									<input id="goodsShowtype10"  name="filmshowtype0" value="0"  type="radio" onclick="changeStyle(this)"/>2D -->
<!-- 									<input id="goodsShowtype11" name="filmshowtype1" value="1"  type="radio"  onclick="changeStyle(this)"/>3D -->
<!-- 									<input id="goodsShowtype12"  name="filmshowtype2" value="2"  type="radio" onclick="changeStyle(this)"/>	IMAX2D -->
<!-- 									<input id="goodsShowtype13" name="filmshowtype3" value="3"  type="radio"  onclick="changeStyle(this)"/>IMAX3D -->
<!-- 									<input id="goodsShowtype14" name="filmshowtype4" value="4"  type="radio"  onclick="changeStyle(this)"/>中国巨幕2D -->
<!-- 								    <input id="goodsShowtype15"  name="filmshowtype5" value="5"  type="radio" onclick="changeStyle(this)"/>	中国巨幕3D -->
<!-- 				</div> -->
			</fieldset>
			<!-- ------------------------------------------------------------选择影片 end----------------------------------------------------------------------------- -->
	...
	<div id="layout_box" style="overflow:hidden" data-options="width: 1050,height: 450,closed: false,cache: false,modal: true,minimizable:false,maximizable:true,collapsible:false"><iframe frameborder="0" width="100%" height="100%"></iframe></div>
</easyui:templateOverride>
<easyui:templateOverride name="script">
	...
	function showFilmDisplay(){
		...
		// 		else{
		// 			if(0==$('input[name^="filmshowtype"]:checked').length){
		// 				alert('请选择参影片放映类型。');
		// 				return;
		// 			}
		// 		}
		...
		function getShowTypes(){
		    ...
		    $('input[name^="filmshowtype"]:checked').each(function(){ //遍历table里的全部checkbox
		    	showtype += ($(this).val()).replace("ck","") + ","; //获取被选中的值
		    });
