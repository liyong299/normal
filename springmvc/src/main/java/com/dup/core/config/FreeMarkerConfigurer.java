...
import com.dup.base.interfaces.IEnum;
import com.dup.base.util.ClassUtils;
...
public class FreeMarkerConfigurer extends
	...
	public void setApplicationContext(ApplicationContext applicationContext) {
		...
		Map<String, AbstractFreeMarkerSettings> freemarkerSettingsMap = context
